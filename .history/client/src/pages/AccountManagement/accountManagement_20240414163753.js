...
const AccountManagement = () => {
  ...
  return (
    ...
    pagination={{
        ...
        showSizeChanger: true, // Cho phép người dùng thay đổi kích thước trang
        pageSizeOptions: ['10', '20', '30'], // Các tùy chọn kích thước trang
        onChange: (page, pageSize) => console.log('Page:', page, 'Page size:', pageSize), // Xử lý sự kiện khi trang hoặc kích thước trang thay đổi
    }}
/>
