...
const AccountManagement = () => {
  ...
  const [selectedRole, setSelectedRole] = useState(null); // State lưu trữ vai trò được chọn
  const [showFacultyFormItem, setShowFacultyFormItem] = useState(false); // Biến flag để kiểm tra hiển thị FormItem chọn faculty

  const handleRoleChange = (value) => {
    setSelectedRole(value); // Cập nhật giá trị vai trò được chọn
    setShowFacultyFormItem(value === "student"); // Thiết lập biến flag dựa trên giá trị của vai trò được chọn
  };
          ...
          <Spin spinning={loading} style={{ overflowY: "hidden" }}>
              ...
              >
                  <Form
                      ...
                      layout="vertical"
                      initialValues={{
                          residence: ["zheijang", "hangzhou", "xihu"],
                          prefix: "86",
                      }}
                      scrollToFirstError
                  >
                      <Form.Item
                          ...
                          rules={[
                              ...
                              {
                                  max: 100,
                                  message: "Name maximum 100 characters",
                              },
