        ...
        <div>
            <Spin spinning={loading}>
                <div className="container">
                    ...
                    {role !== "student" && role !== "admin" &&role !== "department" && (
                            <>
                                <Row gutter={12}>
                                    <Col span={24}>
                                        <h3>
                                            Chart By Academic Year With Faculty{" "}
                                        </h3>
                                        <ResponsiveContainer
                                            width="100%"
                                            height={300}
