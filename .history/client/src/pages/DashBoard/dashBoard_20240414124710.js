...
const DashBoard = () => {
    ...
    const [articeFaculty, setArticleFaculty] = useState(0);
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const [academicRes, facultyRes, statusRes, commentRes] =
                    await Promise.all([dashBoardApi.getArticleByFaculty()]);
