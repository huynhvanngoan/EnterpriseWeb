...
const DashBoard = () => {
    ...
    const [totalByUserFaculty, setTotalByUserFaculties] = useState(0);
        ...
        const fetchData = async () => {
            try {
                ...
                const [
                    ...
                    dashBoardApi.getTotalArticlesWithAcademicYear(),
                    dashBoardApi.getTotalByFaculty(),
                    dashBoardApi.getTotalByStatus(),
                    dashBoardApi.getTotalByComment(),
                    dashBoardApi.getTotalByAcademic(facultyId),
                    dashBoardApi.getTotalByFacultyId(facultyId),
                ...
                setTotalFaculties(academicData);
                ...
                setTotalByUserFaculties(privateData);
                const statusData = [
