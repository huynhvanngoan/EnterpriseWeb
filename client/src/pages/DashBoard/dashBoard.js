        ...
        if (facultyId !== undefined) {
          ...
          const commentData = [
            ...
            },
            {
              ...
              count: commentReponse.data.withoutCommentsAfter14Days,
            },
            {
              name: "Comment",
            ...
            <>
                  ...
                  {role === "guest" ||
                    (role === "marketing" && (
                      <>
                        <Row gutter={12}>
                          <Col span={24}>
                            <h3>Chart By Academic Year With Faculty </h3>
                        ...
                        <Row gutter={12}>
                          <Col span={24}>
                            <h3>Chart By Status With Faculty</h3>
                            <ResponsiveContainer width="100%" height={300}>
                              <BarChart
                                data={totalByStatus}
                                margin={{
                        ...
                        <Row gutter={12}>
                          <Col span={24}>
                            <h3>Chart By Comment With Faculty</h3>
                            <ResponsiveContainer width="100%" height={300}>
                              <BarChart
                                data={totalByComment}
                                margin={{
              ...
              {role === "department" && (
                <>
                  <Row gutter={12}>
                    <Col span={24}>
                      <h3>Chart Articles Of Academic Year </h3>
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart
                          data={totalAcademicYears}
                          margin={{
                        ...
                        >
                          ...
                          <Legend />
                          <Bar dataKey="count">
                            {totalAcademicYears.map((entry, index) => (
                              <Cell
                                key={`cell-${index}`}
                  ...
                  <Row gutter={12}>
                    <Col span={24}>
                      <h3>Chart Contributor Has Article Of Faculty </h3>
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart
                          data={contributor}
                          margin={{
                  ...
                  {totalByFaculty.length > 0 && role === "department" && (
                    <Row gutter={12}>
                      <Col span={24}>
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                          <PieChart width={400} height={400}>
                            ...
                            >
                              ...
                              {totalByFaculty.length > 1 &&
                                totalByFaculty.map((entry, index) => (
                                  <Cell
                                    key={`cell-${index}`}
                                    fill={COLORS[index % COLORS.length]}
                                  />
          ...
          <>
            ...
            <Row gutter={12}>
              {articles.map((article) => (
                <Col span={6} key={article._id} className="text-center">
